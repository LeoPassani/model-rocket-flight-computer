...
<p align="center">
  ...
  &nbsp;&nbsp;&nbsp;
  <img src="https://github.com/user-attachments/assets/308295bc-b0d1-43fd-9301-8d90710e20d3" width="35%">
</p>
...
<p alight="center">
  ...
  &nbsp;&nbsp;&nbsp;
  <img src="https://github.com/user-attachments/assets/74565068-12cb-41aa-99e0-bb654063825e" width = "60%">
</p>
...
<p alight="center">
  <img src="https://github.com/user-attachments/assets/5c4d1069-525d-411c-8a9d-1cc06d569905" width="60%">
  &nbsp;&nbsp;&nbsp;
  <img src="https://github.com/user-attachments/assets/b3d2e13f-38fc-4785-9531-e04906e2cfaf" width ="35%">
</p>
...
While I wasn't completely new to ANSYS Fluent, it's an exceptionally intricate software with a massive learning curve. Everytime I open it, I learn some new functionality or limitation. My license unfortunately limits me to 4 processors, even though performance is already slow enough as is. I experimented with various enclosure sizes, global meshing sizes, refinement regions and values, until the outputted drag coefficient started converging to a consistent value. Thankfully, this occurred at a relatively reasonable mesh fineness, although I'm sure there are some info lost or deformed by my meshing. The meshing includes a inflation layer of 10 layers, a body refinement on the surface of the rocket, and a refined region encapsulating both the rocket and its wake. I've included pictures of meshing, streamlines, contour, and vector fields below. There is a strong wake and recirculation behind the rocket, as well as a clear boundary layer along the surface of the rocket. For future projects, I would try adding further refinement to the fins and nose tip.

<img width="1488" height="771" alt="Mesh" src="https://github.com/user-attachments/assets/9e059a94-0701-4fb8-b387-6141083d7c58" />
<img width="1492" height="771" alt="Mesh3" src="https://github.com/user-attachments/assets/3e592d0d-9918-4eed-972a-76c610850954" />
<img width="552" height="926" alt="Countour" src="https://github.com/user-attachments/assets/8328f296-b6e4-4d90-9e68-72f670dd2129" />
<img width="1434" height="950" alt="3DStreamline" src="https://github.com/user-attachments/assets/16d2f5f4-e9ea-4541-85fa-7522a16da3ed" />
<img width="1434" height="950" alt="WakeStreamline" src="https://github.com/user-attachments/assets/30ab8eeb-96b4-4454-ac08-cf036c78f7cd" />
<img width="1955" height="1040" alt="Cd" src="https://github.com/user-attachments/assets/64fb1c3e-d77c-4e4d-a37e-d6c96bfc5201" />
